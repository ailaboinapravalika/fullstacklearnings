...
const App = () => (
  <div className="bg-tech-cards">
    <h1 className="header-text">Learn 4.0 Technologies</h1>
    ...
    {cardsList.map(cardDetails => (
      <CardItem cardDetails={cardDetails} key={cardDetails.id} />
    ))}
  </div>
)
export default App
